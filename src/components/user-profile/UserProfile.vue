      ...
      <div class="user-info">
        <div class="user-avatar">
          <img
            ...
            src="http://p1.music.126.net/uAJkvQYbojqFXHZrjKz97w==/109951164336447751.jpg?param=80y80"
          />
        </div>
        <div class="info">
          <h4 class="name">
            <span class="text">撇捺z</span>
            <i class="icon-info"></i>
          </h4>
          <p class="lv">
            <i class="lv-icon-left">7</i>
            <i class="lv-icon-right"></i>
          </p>
          <button class="btnwarp">
