  ...
  <div class="audio-playbar">
    ...
    <div class="song">
      ...
      <div class="song-info">
        ...
        <span class="link" @click="jumpSongPosition"></span>
      </div>
    </div>
...
function getAudioPlayUrl(): Promise<void> {
...
// 播放模式
const modeTip = reactive<{ visible: boolean; timer: NodeJS.Timeout | null }>({
  visible: false,
  timer: null
});
