  ...
  <div class="home-album">
    <div class="home-album-container">
      ...
      <div class="album-title">
        全部新碟
        <ul class="tab">
          <li class="item first-item" @click="albumTypeChange('ALL')">全部</li>
          <li class="item" @click="albumTypeChange('ZH')">华语</li>
          <li class="item" @click="albumTypeChange('EA')">欧美</li>
          <li class="item" @click="albumTypeChange('KR')">韩国</li>
          <li class="item last-item" @click="albumTypeChange('JP')">日本</li>
        </ul>
      </div>
      <ul class="album-list">
...
// 全部新碟 - 类型切换
function albumTypeChange(type: string): void {
  params.area = type;
  getNweAlbum();
}
